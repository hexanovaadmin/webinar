...
const WebinarAdminWebinarListTab = () => {
  return (
    <div className="WebinerListBox ir-ws-flex ir-ws-justify-center">
      <div className="WebinerList ir-ws-position-relative">
        <div className="WebinerListItems">
          <p className="WebinarListHeading">Webinar Name</p>
          <div className="buttons ir-ws-flex flex-column ">
        ...
        <div className="arrow ir-ws-position-absolute">
